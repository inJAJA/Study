...
class GAN(object):
    ...
    def generator(self):
        ...
        sty = MaxPooling2D(2)(sty)
        sty = Conv2D(256, (3, 3), padding = 'same', kernel_initializer = 'he_normal')(sty)
        sty = BatchNormalization()(sty)
        sty = LeakyReLU(0.1)(sty)
        sty = MaxPooling2D(2)(sty)
        sty = Conv2D(128, (3, 3), padding = 'same', kernel_initializer = 'he_normal')(sty)
        sty = BatchNormalization()(sty)
        sty = LeakyReLU(0.1)(sty)
        sty = MaxPooling2D(2)(sty)
        sty = Conv2D(64, (3, 3), padding = 'same', kernel_initializer = 'he_normal')(sty)
        sty = BatchNormalization()(sty)
        sty = LeakyReLU(0.1)(sty)
        sty = MaxPooling2D(2)(sty)
        sty = Conv2D(32, (3, 3), padding = 'same', kernel_initializer = 'he_normal')(sty)
        sty = BatchNormalization()(sty)
        sty = LeakyReLU(0.1)(sty)
        sty = MaxPooling2D(2)(sty)
        sty = Conv2D(8, (3, 3), padding = 'same', kernel_initializer = 'he_normal')(sty)
        sty = BatchNormalization()(sty)
        sty = LeakyReLU(0.1)(sty)
...
class WGAN(object):
    ...
    def save(self, num): #Save JSON and Weights into /Models/
        self.saveModel(self.GAN.G, "gen_c3", num)
        self.saveModel(self.GAN.D, "dis_c3", num)
    ...
    def load(self, num): #Load JSON and Weights from /Models/
        ...
        #Load Models
        self.GAN.G = self.loadModel("gen_c3", num)
        self.GAN.D = self.loadModel("dis_c3", num)
