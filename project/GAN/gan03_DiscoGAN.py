...
import sys
from gan03_data_loader import DataLoader # 파일 불러오기
import numpy as np
import os
...
class DiscoGAN():
    def __init__(self):
        ...
        self.d_A.compile(loss = 'mse', optimizer = optimizer, metrics = ['acc'])
        self.d_B.compile(loss = 'mse', optimizer = optimizer, metrics = ['acc'])
