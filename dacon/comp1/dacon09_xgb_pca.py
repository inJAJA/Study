...
y_predict = model.predict(x_pred).reshape(-1, 1)

y_predict = pca.inverse_transform(y_predict)
y_predict = scaler.inverse_transform(y_predict)

# submission
a = np.arange(10000,20000)
submission = pd.DataFrame(y_predict, a)
submission.to_csv('D:/Study/dacon/comp1/sub_XG_pca.csv',index = True, header=['hhb','hbo2','ca','na'],index_label='id')

print(submission.shape)

'''
mae:  0.640450526740389
'''