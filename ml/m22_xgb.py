...
# parameter
n_estimator = 100          # 나무의 개수 ( 앙상블 )
learning_rate = 0.01       # 학습률 : 이걸 건드는 것이 제일 효과가 크다. / default = 0.01
colsample_bytree = 0.9     # 각 트리마다의 feature 샘플링 비율 :0.6 ~ 0.9  / max 1  // 샘플 = 전체 나무 ( dropout과 유사 )
colsample_bylevel = 0.9    # 샘플을 어느정도 사용할 것인가.     : 0.6 ~ 0.9 / max 1
